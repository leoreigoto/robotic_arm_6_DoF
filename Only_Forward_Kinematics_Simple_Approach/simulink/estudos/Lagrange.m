...
CGtarefa=[-0.0047;-0.00130;0.01830];
...
% Energias
EC1 = ((m(2)*dP0_G1')*dP0_G1 + W0_1'*((T_01(1:3,1:3)*I2*T_01(1:3,1:3)')*W0_1))/2; % Braço
EC2 = ((m(3)*dP0_G2')*dP0_G2 + W0_2'*((T_02(1:3,1:3)*I3*T_02(1:3,1:3)')*W0_2))/2;
EC3 = ((m(4)*dP0_G3')*dP0_G3 + W0_3'*((T_03(1:3,1:3)*I4*T_03(1:3,1:3)')*W0_3))/2;
EC4 = ((m(5)*dP0_G4')*dP0_G4 + W0_4'*((T_04(1:3,1:3)*I5*T_04(1:3,1:3)')*W0_4))/2; % Pulso
EC5 = ((m(6)*dP0_G5')*dP0_G5 + W0_5'*((T_05(1:3,1:3)*I6*T_05(1:3,1:3)')*W0_5))/2;
EC6 = ((m(7)*dP0_G6')*dP0_G6 + W0_6'*((T_06(1:3,1:3)*I7*T_06(1:3,1:3)')*W0_6))/2;
EP1 = (-m(2)*gravidade'*(P0_G1(1:3,1))); % Braço
...
L = (EC1 + EC2 + EC3 + EC4 + EC5 + EC6) - (EP1 + EP2 + EP3 + EP4 + EP5 + EP6);
